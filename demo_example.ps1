...
$ASSET_PATH = "/Game/LLMGenerated/Blueprints"
$BLUEPRINT_NAME = "HunYuanMeshBP"
$SPAWN_LOCATION = "0,0,100"  # X,Y,Z coordinates

Write-Host "========================================================"
Write-Host "HunYuan3D-v2 to Unreal Engine 5 Workflow Demo"
Write-Host "========================================================"
...
Write-Host "Step 1: Import OBJ to UE5"
Write-Host "-------------------------"
...
Write-Host "bp_path = demo.import_to_ue5('$SAMPLE_OBJ', '$ASSET_PATH', '$BLUEPRINT_NAME')"
Write-Host "print(f'Blueprint created at: {bp_path}')"
Write-Host ""
...
Write-Host ""
Write-Host "Step 3: Place the object in the game using UnrealCV"
Write-Host "--------------------------------------------------"
Write-Host "Running command to place the object in the game:"
Write-Host "python hunyuan3d_ue5_demo.py --action place --blueprint_path $ASSET_PATH/$BLUEPRINT_NAME --location $SPAWN_LOCATION"
Write-Host ""
...
Write-Host "========================================================"
Write-Host "You have successfully completed the HunYuan3D to UE5 workflow demo."
